...
import 'package:fastpay_sdk/src/core/api_exception.dart';
...
void main() {
  ...
  test('resolveAccessToken returns the initialized static access token', () async {
    FastPay.initialize(
      const FastPayConfig(
  ...
  test('resolveAccessToken exchanges api credentials from an explicit config', () async {
  ...
  test('resolveAccessToken fails before initialization when base config is missing', () async {
    expect(
